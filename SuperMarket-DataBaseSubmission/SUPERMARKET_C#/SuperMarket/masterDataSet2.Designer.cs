...
namespace SuperMarket {
    ...
    public partial class masterDataSet2 : global::System.Data.DataSet {
        ...
        public partial class CUSTOMERDataTable : global::System.Data.TypedTableBase<CUSTOMERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CUSTOMERRow AddCUSTOMERRow(string FNAME, string LNAME, string C_ADDRESS, string USERNAME, string PASSWORD) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CUSTOMERRow FindByCUSTOMER_IDPASSWORD(int CUSTOMER_ID, string PASSWORD) {
...
namespace SuperMarket.masterDataSet2TableAdapters {
    ...
    public partial class CUSTOMERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[CUSTOMER] WHERE (([CUSTOMER_ID] = @Original_CUSTOMER_ID) AND ([FNAME] = @Original_FNAME) AND ([LNAME] = @Original_LNAME) AND ([C_ADDRESS] = @Original_C_ADDRESS) AND ([USERNAME] = @Original_USERNAME) AND ([PASSWORD] = @Original_PASSWORD))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[CUSTOMER] ([FNAME], [LNAME], [C_ADDRESS], [USERNAME], [PASSWORD]) VALUES (@FNAME, @LNAME, @C_ADDRESS, @USERNAME, @PASSWORD);
SELECT CUSTOMER_ID, FNAME, LNAME, C_ADDRESS, USERNAME, PASSWORD FROM CUSTOMER WHERE (CUSTOMER_ID = SCOPE_IDENTITY()) AND (PASSWORD = @PASSWORD)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CUSTOMER] SET [FNAME] = @FNAME, [LNAME] = @LNAME, [C_ADDRESS] = @C_ADDRESS, [USERNAME] = @USERNAME, [PASSWORD] = @PASSWORD WHERE (([CUSTOMER_ID] = @Original_CUSTOMER_ID) AND ([FNAME] = @Original_FNAME) AND ([LNAME] = @Original_LNAME) AND ([C_ADDRESS] = @Original_C_ADDRESS) AND ([USERNAME] = @Original_USERNAME) AND ([PASSWORD] = @Original_PASSWORD));
SELECT CUSTOMER_ID, FNAME, LNAME, C_ADDRESS, USERNAME, PASSWORD FROM CUSTOMER WHERE (CUSTOMER_ID = @CUSTOMER_ID) AND (PASSWORD = @PASSWORD)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SuperMarket.Properties.Settings.Default.masterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CUSTOMER_ID, FNAME, LNAME, C_ADDRESS, USERNAME, PASSWORD FROM dbo.CUSTOMER" +
                "";
        ...
        public virtual int Delete(int Original_CUSTOMER_ID, string Original_FNAME, string Original_LNAME, string Original_C_ADDRESS, string Original_USERNAME, string Original_PASSWORD) {
        ...
        public virtual int Insert(string FNAME, string LNAME, string C_ADDRESS, string USERNAME, string PASSWORD) {
            if ((FNAME == null)) {
        ...
        public virtual int Update(string FNAME, string LNAME, string C_ADDRESS, string USERNAME, string PASSWORD, int Original_CUSTOMER_ID, string Original_FNAME, string Original_LNAME, string Original_C_ADDRESS, string Original_USERNAME, string Original_PASSWORD, int CUSTOMER_ID) {
            if ((FNAME == null)) {
                throw new global::System.ArgumentNullException("FNAME");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FNAME, string LNAME, string C_ADDRESS, string USERNAME, int Original_CUSTOMER_ID, string Original_FNAME, string Original_LNAME, string Original_C_ADDRESS, string Original_USERNAME, string Original_PASSWORD) {
            return this.Update(FNAME, LNAME, C_ADDRESS, USERNAME, Original_PASSWORD, Original_CUSTOMER_ID, Original_FNAME, Original_LNAME, Original_C_ADDRESS, Original_USERNAME, Original_PASSWORD, Original_CUSTOMER_ID);
        }
    }
